					...
					<li class="header-nav-brand">
						<div class="brand-holder">
							<span class="location_text">
								<a href="/admin/contents/comment">회사 목록</a>	
							</span>
						</div>
					</li>
				</ul>
										...
										<div class="card-body no-padding">
											<div class="li_table" id="UI_TABLE">
												<ul class="subject _thead" id="table-header" style="">
													...
													<li class="company_name"><a href="#">회사명</a></li>
													<li class="account">설명</li>
													<li class="date_join">
														<a href="/admin/member/list/?q=YToxOntzOjEwOiJqb2luX29yZGVyIjtzOjQ6ImRlc2MiO30%3D&amp;join_order=asc">생성일                                                       <i class="md md-expand-less"></i>
															<!--역순일 때 <i class="md md-expand-less"></i> -->
														</a>
													</li>
													<li class="count_post">관련 게시글</li>
													<li class="action"></li>
												</ul>
												...
												<ul class="content _tbody" id="member_item_m20220929a41c742d48942" data-nick="관리자" data-app="">
													...
													<li class="nick">
														<a href="/admin/member/list/?q=YToxOntzOjEwOiJqb2luX29yZGVyIjtzOjQ6ImRlc2MiO30%3D&amp;mode=add&amp;idx=22645265" onclick="">
															넥슨
														</a>
													</li>

													<li class="account">
														<a href="/admin/member/list/?q=YToxOntzOjEwOiJqb2luX29yZGVyIjtzOjQ6ImRlc2MiO30%3D&amp;mode=add&amp;idx=22645265" onclick="">메이플스토리로 유명한 게임 회사</a>
													</li>
													
													<li class="account">1900-11-13</li>
					...
					<ul id="main-menu" class="gui-controls">
						...
						<li class="active gui-folder expanded" data-title="member">
							...
							<ul>
								...
								<li class="active expanded" data-title="company_list">
									<a href="/companyList.jsp" class=" active">
