					...
					<li class="header-nav-brand">
						<div class="brand-holder">
							<span class="location_text">
								<a href="/admin/contents/comment">문의글 관리</a>	
							</span>
						</div>
					</li>
				</ul>
						...
						<div class="col-md-3 hidden-md hidden-lg">
							<div class="card">
								<div class="card-body sm-padding-y">
									<select class="form-control no-border" onchange=" ">
										<option value="">전체 게시물(0)</option>
										<option value="b202209290c499abc188d3">notice (0)</option>
									</select>
								</div>
							</div>
						</div>
							...
							<div class="row">
										...
										<div class="card-body no-padding">
											<form role="search" class="user-search">
												<div class="form-group">
													...
													<div id="prefetch">
														<input type="text" placeholder="작성자, 문의글 제목 검색" id="postSearch" name="keyword" class="form-control typeahead">
													</div>
												</div>
											</form>
										</div>
								...
								<div class="col-md-12">
									<div class="card">
										<div class="card-head">
											<header class="small"> 
												문의글 <span id="comment_count" class="text-primary">0</span>
											</header>
										</div>
												...
												<ul class="subject">
													<li class="check">
														<div class="checkbox checkbox-styled no-margin">
															<label>
																<input type="checkbox" value="" class="_all_check" onclick="TABLE_LIST.allCheckToggle()"><span></span>
															</label>
														</div>
													</li>

													<li class="lang_icon" style="width:20px;"></li>
													<li class="title">제목</li>
													<li class="author">작성자</li>
													<li class="date">작성일</li>
													<li class="commentCount">댓글수</li>
													<li class="view">조회수</li>                                        
													<li class="view">답변 여부</li>
													<li class="action"></li>
												</ul>
											</div>
											<!--end.li_table-->
					...
					<ul id="main-menu" class="gui-controls">
						...
						<li class="active gui-folder expanded" data-title="contents"> <!-- 현재 이동한 페이지의 카테고리를 활성화 시켜줘야함 -->
							...
							<ul>
                                ...
                                <li class="active expanded" data-title="contents_injuiry"> <!-- a태그의 클래스명이 li 태그 클래스에 출가된다. 활성화 된 클래스 표시(active) -->
									<a href="contentInquiry.jsp" class=" active"> <!-- 해당 페이지의 목록에 active가 들어가야지 음영처리가된다. -->
