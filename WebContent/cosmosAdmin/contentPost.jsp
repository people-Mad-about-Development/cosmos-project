					...
					<li class="header-nav-brand">
						<div class="brand-holder">
							<span class="location_text">
								<a href="/admin/contents/comment">게시물 관리</a>	
							</span>
						</div>
					</li>
				</ul>
										...
										<div class="card-body no-padding">
											<form role="search" class="user-search">
												<div class="form-group">
													...
													<div id="prefetch">
														<input type="text" placeholder="작성자, 제목 검색" id="postSearch" name="keyword" class="form-control typeahead">
													</div>
												</div>
											</form>
										</div>
				...
				<div class="menubar-scroll-panel" style="padding-bottom: 1px;">
					...
					<ul id="main-menu" class="gui-controls">
						...
						<li class="active gui-folder expanded" data-title="contents"> <!-- 현재 이동한 페이지의 카테고리를 활성화 시켜줘야함 -->
							...
							<ul>
								<li class="active expanded" data-title="contents_post">
									<a href="contentPost.jsp" class=" active">  <!-- 각각의 주소를 입력해줘야 페이지 이동 가능 -->
