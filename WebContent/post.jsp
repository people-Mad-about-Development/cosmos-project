        ...
        <div class="main_categoryWrapper">
            <section class="main_category">
                <div class="main_category_item main_active">
                    <svg width="24" height="24" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 9.51447L15.7458 1.25732L31 9.51447L15.7458 18.2573L1 9.51447Z" stroke="#333333" stroke-width="2" stroke-linejoin="round"></path><path d="M1 16.2573L15.7458 25.0002L31 16.2573" stroke="#333333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M1 23L15.7458 31.7429L31 23" stroke="#333333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                ...
                <div class="main_category_item main_inactive">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11 21H21" stroke="#858E86" stroke-width="1.5" stroke-linecap="round"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M16.8845 4.82378C15.5155 3.62383 13.4241 3.74942 12.2122 5.10499C12.2122 5.10499 6.18886 11.8419 4.10018 14.1803C2.00875 16.5174 3.54182 19.746 3.54182 19.746C3.54182 19.746 6.994 20.8285 9.05372 18.5242C11.1148 16.2198 17.1685 9.45019 17.1685 9.45019C18.3804 8.09462 18.2522 6.02372 16.8845 4.82378Z" stroke="#858E86" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10.3604 7.29248L14.9255 11.2792" stroke="#858E86" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
            ...
            <div class="toggleSwitch">
                ...
                <label for="swtichInput" class="toggleSwitch_switchLabel toggleSwitch_Checked">
                    <input type="checkbox" class="toggleSwitch_switchCheckbox" id="switchInput" name="switchInputtag" checked>
...
<script>
    ...
    var $label =$('.toggleSwitch_Checked');
    ...
    $toggle.click(function(){
        ...
        if($($switch).is(":checked")){
            $label.css("background-color","#ffcd00")
        }else{
            $label.css("background-color","#c1cbd8")
        }
    })
