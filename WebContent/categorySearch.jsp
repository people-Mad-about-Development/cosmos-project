...
<body>
    <section class="filter">
        ...
        <ul class="language">
            ...
            <li class="languageBar languageBar_full"><img src="banner/navericon.png" alt=""
                    class="languageBarLogo"><span>네이버</span></li>
            <li class="languageBar languageBar_full"><img src="banner/kakaoicon.jpg" alt=""
                    class="languageBarLogo"><span>카카오</span></li>
            <li class="languageBar languageBar_full"><img src="banner/liotIcon.png" alt=""
                    class="languageBarLogo"><span>라이엇</span></li>
            <li class="languageBar languageBar_full"><img src="banner/coupangicon.jpg" alt=""
            ...
            <li class="languageBar languageBar_full"><img src="banner/baeminicon.png" alt=""
