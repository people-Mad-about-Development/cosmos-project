...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/post/post.css">
</head>
            ...
            <section class="main_category">
                <div class="main_category_item main_active">
                    <svg width="24" height="24" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 9.51447L15.7458 1.25732L31 9.51447L15.7458 18.2573L1 9.51447Z" stroke="#333333"
                            stroke-width="2" stroke-linejoin="round"></path>
                        <path d="M1 16.2573L15.7458 25.0002L31 16.2573" stroke="#333333" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M1 23L15.7458 31.7429L31 23" stroke="#333333" stroke-width="2" stroke-linecap="round"
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g mask="url(#mask0_859_3602)">
                            <path
                                ...
                                fill="#858E86"></path>
                            <path d="M8.75 14.25H15.25" stroke="#858E86" stroke-width="1.5" stroke-linecap="round">
                            </path>
                        </g>
                    </svg>
                ...
                <div class="main_category_item main_inactive">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11 21H21" stroke="#858E86" stroke-width="1.5" stroke-linecap="round"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#858E86" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M10.3604 7.29248L14.9255 11.2792" stroke="#858E86" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
            ...
            <div class="toggleWrapperMain">
                ...
                <div class="toggleSwitchWrapper">
                    <div class="toggleSwitch">
                        <span class="toggleSwitch_switchTitle">최신 순</span>
                        <label for="swtichInput" class="toggleSwitch_switchLabel toggleSwitch_UnChecked">
                            <input type="checkbox" class="toggleSwitch_switchCheckbox" id="switchInput"
                                name="switchInputtag">
                            <div class="toggleSwitch_ball"></div>
                        </label>
                    </div>
                    <div class="toggleSwitch">
                        <span class="toggleSwitch_switchTitle">조회 순</span>
                        <label for="swtichInput" class="toggleSwitch_switchLabel toggleSwitch_UnChecked">
                            <input type="checkbox" class="toggleSwitch_switchCheckbox" id="switchInput"
                                name="switchInputtag">
                            <div class="toggleSwitch_ball"></div>
                    ...
                    <div class="toggleSwitch">
                        <span class="toggleSwitch_switchTitle">모집 중만 보기</span>
                        <label for="swtichInput" class="toggleSwitch_switchLabel toggleSwitch_Checked">
                            <input type="checkbox" class="toggleSwitch_switchCheckbox" id="switchInput"
                                name="switchInputtag" checked>
                            <div class="toggleSwitch_ball"></div>
                        </label>
                    </div>
                        ...
                        <div class="studyItem_language_wrapper">
                            <ul class="studyItem_content">
                                <li class="studyItem_language">
                                    <img src="https://holaworld.io/images/languages/figma.svg" alt=""
                                        class="studyItem_languageImage">
                                </li>

                                <li class="studyItem_language">
                                    <img src="https://holaworld.io/images/languages/zeplin.svg" alt=""
                                        class="studyItem_languageImage">
                                </li>
                            </ul>
                        </div>
                        <section class="studyItem_info">
                            <div class="avatar_user">
                                <img class="avatar_userImg avatar_small"
                                    src="https://hola-post-image.s3.ap-northeast-2.amazonaws.com/amoo_2022-07-03_18-07-05.png"
                                    alt="avatar">
                            ...
                            <div class="studyItem_viewsAndComment">
                                <div class="studyItem_infoItem">
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                        viewBox="0 0 1024 1024" color="#999999" height="28" width="28"
                                ...
                                <div class="studyItem_infoItem">
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                        viewBox="0 0 512 512" color="#999999" height="20" width="20"
                                        xmlns="http://www.w3.org/2000/svg" style="color: rgb(153, 153, 153);">
                                        <path
