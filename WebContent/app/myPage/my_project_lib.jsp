                    ...
                    <li class="community-aside_group">
                        ...
                        <ul class="community-aside__menu-list">
                            ...
                            <li class="community-aside__menu ">
                                <a  onclick="noticeMove()"><span>공지사항</span></a>
                            </li>
                            <script >
                            	function noticeMove(){
                            	$(".dimmed_233vf").css("display","grid");
                            	location.href= "${pageContext.request.contextPath}/community/noticeListOk.co?boardNumber=${boardNumber}&userNumber=${userNumber}"
                            	}
							</script>
            ...
            <div class="community-body__content">
                <div class="question-list-container">
                    <div class="post-container-header">
                        ...
                        <button class="all-button write-btn" id="second-btn" onclick="libPageMove()">
                        ...
                        <script >
                        function libPageMove(){
                        	 $(".dimmed_233vf").css("display","grid");
                             location.href = '${pageContext.request.contextPath}/community/libraryCreate.co'
                        }
			                    ...
			                    <li class="question-container">
			                        <a onclick="detailLib()">
			                            <script >
					                        function detailLib(){
					                        	 $(".dimmed_233vf").css("display","grid");
					                             location.href = '${pageContext.request.contextPath}/community/libraryDetailOk.co?boardNumber=${list.getBoardNumber()}&communityNumber=${list.getCommunityNumber()}&userNumber=${list.getUserNumber()}'
					                        }
