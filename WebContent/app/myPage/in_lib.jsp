    ...
    <div id="root">
        <div class="studyContent_postWrapper">
            <section class="studyContent_postHeader">
                 <button type="button" onclick="location.href = '${pageContext.request.contextPath}/community/libraryListOk.co?boardNumber=${text.getBoardNumber()}'">
           ...
           ></path>
                ...
                <%-- <c:if test="${userNumber eq text.getUserNumber()}"> --%>
		            <section class="studyButtons_buttonWrapper">
	                    <button class="studyButtons_buttons" onclick="location.href = '${pageContext.request.contextPath}/community/libraryModify.co?communityNumber=${text.getCommunityNumber()}&boardNumber=${text.getBoardNumber()}&userNumber=1'">수정</button>
	                    <button class="studyButtons_buttons" onclick="location.href = '${pageContext.request.contextPath}/community/libraryDeleteOk.co?communityNumber=${text.getCommunityNumber()}&boardNumber=${text.getBoardNumber()}'">삭제</button>
                	</section>
                <%-- </c:if> --%>
