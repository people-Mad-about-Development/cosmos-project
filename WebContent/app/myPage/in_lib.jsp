...
<link rel="stylesheet" href="../../assets/css/in_anything.css">
</head>
          ...
          273c-9.4-9.4-9.4-24.6 0-33.9L201.4 44.7c9.4-9.4 24.6-9.4 33.9 0l22.2 22.2c9.5 9.5
           ...
           ></path>
                ...
                <div class="studyContent_userAndDate">
                    <img class="studyContent_userImg" src="img/default.png".png"
                     alt="userImg">
                                    ...
                                    <li class="commentItem_commentContainer">
                                        <section class="commentItem_commentHeader">
                                            <div class="commentItem_avatarWrapper">
                                                <img class="commentItem_userImg" src="img/default.png" alt="사용자 이미지">
                                        ...
                                        <textarea class="commentItem_modifyInput" name="contentInput" placeholder="안녕" style="resize: none;" >안녕</textarea>
                                        
                                               <!--  <input class="commentItem_modifyInput" type="text" name="contentInput" placeholder="안녕" value="안녕"> -->
                                                    <div class="commentItem_commentInputButton">
                                                        <button class="commentItem_buttonCancel" name="complete">취소</button>
                                                        <a href="boardComment.jsp">
                                                        <button class="commentItem_buttonComplete" name="cancel">완료</button>
                                                        </a>
                                                    </div>
                                                </div>
                                        </section>
