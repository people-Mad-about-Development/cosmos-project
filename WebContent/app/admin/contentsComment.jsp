						...
						<li class="header-nav-brand">
							<div class="brand-holder">
								<span class="location_text">
									<a href="${pageContext.request.contextPath}/app/admin/contentsComment.jsp">댓글 관리</a>	<!-- 동일 페이지로 재이동 -->
								</span>
							</div>
						</li>
					</ul>
					...
					<ul id="main-menu" class="gui-controls">
						...
						<li class="active gui-folder expanded" data-title="contents"> 
							...
							<ul>
								...
								<li class="active expanded" data-title="contentsComment"> 
									<a href="${pageContext.request.contextPath}/app/admin/contentsComment.jsp"  class=" active">
									...
									<div class="col-md-2 hidden-xs">
										<div class="card">
											<div class="companyDelete">
												<a href="#modal;" rel="modal:open">선택 댓글 삭제</a>
												<span>
											...
											<div class="card-body no-padding">
												<div class="li_table" id="UI_TABLE">
													<ul class="subject _thead" id="table-header" >
														...
														<li class="commentNick">작성자</li> 
														<li class="comment">내용</li>
														<li class="commentPost">작성 게시글</li>
...
<script src="${pageContext.request.contextPath}/assets/js/admin/contentsComment.js"></script>
</html>