						...
						<li class="header-nav-brand">
							<div class="brand-holder">
								<span class="location_text">
									<a href="${pageContext.request.contextPath}/app/admin/contentPost.jsp">게시물 관리</a>	<!-- 동일 페이지로 재이동 -->
								</span>
							</div>
						</li>
					</ul>
...
<script src="${pageContext.request.contextPath}/assets/js/admin/contentPost.js"></script>
</html>