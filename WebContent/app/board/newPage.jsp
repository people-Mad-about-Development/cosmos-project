            ...
            <section>
                ...
                <span aria-live=" polite" aria-atomic="false" aria-relevant="additions text"
                            ...
                            <div class="select__menu css-26l3qy-menu newInAction">
                                <div class="select__menu-list css-11unzgr">
                                    <div class="select__option select__option--is-focused css-1n7v3ny-option"
                                        id="react-select-3-option-0" tabindex="-1">인원 미정</div>
                                    ...
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-7"
                                        tabindex="-1">7명</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-8"
                                        tabindex="-1">8명</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-9"
                                        tabindex="-1">9명</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-10"
                                        tabindex="-1">10명 이상</div>
                                </div>
                            </div>
                    ...
                    <li class="postinfo_listItem__OFhXr">
                        ...
                        <div class=" css-2b097c-container css_newT3">
                            ...
                            <div class="select__menu css-26l3qy-menu newInAction">
                                <div class="select__menu-list css-11unzgr">
                                    <div class="select__option select__option--is-focused css-1n7v3ny-option"
                                        id="react-select-3-option-0" tabindex="-1">기간 미정</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-1"
                                        tabindex="-1">1개월</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-2"
                                        tabindex="-1">2개월</div>
                    ...
                    <li class="postinfo_listItem__OFhXr">
                        ...
                        <div class=" css-2b097c-container css_newT4">
                                ...
                                <div class="select__value-container select__value-container--is-multi css-1hwfws3">
                                    ...
                                    <div class="css-1g6gooi">
                                        ...
                                        <div class="select__input" style="display: inline-block;">
                                            ...
                                            <input autocapitalize="none" autocomplete="off" autocorrect="off"
                                                id="react-select-6-input" spellcheck="false" tabindex="0" type="text"
                                                aria-autocomplete="list" value=""
                                                style="box-sizing: content-box; width: 2px; background: 0px center; border: 0px; font-size: inherit; opacity: 1; outline: 0px; padding: 0px; color: inherit;">
                            ...
                            <div class="select__menu css-26l3qy-menu newInAction">
                                <div class="select__menu-list css-11unzgr">
                                    <div class="select__option select__option--is-focused css-1n7v3ny-option"
                                        id="react-select-3-option-0" tabindex="-1">JavaScript</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-1"
                                        tabindex="-1">TypeScript</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-2"
                                        tabindex="-1">React</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-3"
                                        tabindex="-1">Vue</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-4"
                                        tabindex="-1">Nodejs</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-5"
                                        tabindex="-1">Spring</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-6"
                                        tabindex="-1">Java</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-7"
                                        tabindex="-1">Nextjs</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-8"
                                        tabindex="-1">Express</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-9"
                                        tabindex="-1">Go</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-10"
                                        tabindex="-1">C</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-11"
                                        tabindex="-1">Python</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-12"
                                        tabindex="-1">Django</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-13"
                                        tabindex="-1">Swift</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-14"
                                        tabindex="-1">Kotlin</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-15"
                                        tabindex="-1">MySQL</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-16"
                                        tabindex="-1">MongoDB</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-17"
                                        tabindex="-1">php</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-18"
                                        tabindex="-1">GraphQL</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-19"
                                        tabindex="-1">Firebase</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-20"
                                        tabindex="-1">ReactNative</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-21"
                                        tabindex="-1">Unity</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-22"
                                        tabindex="-1">Flutter</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-23"
                                        tabindex="-1">AWS</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-24"
                                        tabindex="-1">Kubernetes</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-25"
                                        tabindex="-1">Docker</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-26"
                                        tabindex="-1">Git</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-27"
                                        tabindex="-1">Figma</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-28"
                                        tabindex="-1">Zeplin</div>
                                </div>
                            </div>
                    ...
                    <li class="postinfo_listItem__OFhXr">
                        ...
                        <div class=" css-2b097c-container css_newT5">
                            ...
                            <div class="select__menu css-26l3qy-menu newInAction">
                                <div class="select__menu-list css-11unzgr">
                                    <div class="select__option select__option--is-focused css-1n7v3ny-option"
                                        id="react-select-3-option-0" tabindex="-1">카카오톡 오픈채팅</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-1"
                                        tabindex="-1">이메일</div>
                                    <div class="select__option css-yt9ioa-option" id="react-select-3-option-2"
                                        tabindex="-1">구글폼</div>
