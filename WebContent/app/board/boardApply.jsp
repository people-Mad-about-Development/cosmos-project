...
<meta charset="UTF-8">
<title>지원자 정보</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/board/boardApply.css">
</head>
<body>  
    <div class="search_results" style="margin-top:50px;">
         <a href="${pageContext.request.contextPath}/app/board/boardProject.jsp">
                    ...
                    <div class="extra">
                        <div class="request-button" data-url="/api/users/324116/request_button">
                            <div class="ui mini basic buttons" onclick="handleClick()" >
                                <a  class="ui basic button" onclick="handleClick()" >
                                    합격
                                </a>
            ...
            <div class="ui divider"></div>
                ...
                <div class="ui user card" data-search-item-user-id="203605" relationship-data-setted="true">
                    ...
                    <div class="extra">
                        <div class="request-button" data-url="/api/users/324116/request_button">
                            <div class="ui mini basic buttons">
                                <a  class="ui basic button" onclick="init()">합격</a>
                                <a  class="ui basic button">불합격</a>
                            </div>
                        </div>
                    </div>
