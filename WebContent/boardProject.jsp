    ...
    <div class="modal">
      ...
      <div class="content">
          ...
          <section class="cancelButton_buttons">
            <button class="cancelButton_cancelButton" id="yes">네</button>
            <button class="cancelButton_registerButton" onclick="closeModal()">아니요</button>
        </section>
      </div>
    </div>
  </div>
<div class="modal-wrapper2">
    <div class="modal">
      ...
      <div class="content">
          ...
          <section class="cancelButton_buttons">
            <button class="cancelButton_cancelButton">네</button>
            <button class="cancelButton_registerButton" onclick="closeModal()">아니요</button>
        </section>
      </div>
    </div>
